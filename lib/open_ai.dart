...
Future<String> callOpenAI(int promptOption, Patient patient) async {
  ...
  if (promptOption == 1) {
    ...
    prompt = "Could you provide a summary of the patient given the following information: name is ${patient.name}, "
    ...
    prompt = "A patient has the following medical history: $medicalHistory. Provide a summary of the patient's medical history.";
  }
